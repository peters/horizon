...
[`docs/architecture/browser-packaging.md`](https://github.com/peters/horizon/blob/main/docs/architecture/browser-packaging.md).
...
[`scripts/check-browser-packaging.sh`](https://github.com/peters/horizon/blob/main/scripts/check-browser-packaging.sh).
