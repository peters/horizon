...
pub struct SpeechConfig {
    ...
    /// When true, push-to-talk with no focused Horizon window inserts through
    /// the focused Linux accessibility object. The clipboard is not used.
    /// Background dictation currently requires an X11 global grab. Mic-button
