...
fn v1_json_contract_round_trips() {
    ...
    for image in "https://u:p@r/i?q / .. image: ghcr.io/Org/image image@sha256:deadbeef image@sha256:dddddddddddddddddddddddddddddddd [::::]/image registry.example:70000/team/image registry.example:0/team/image".split_ascii_whitespace() {
