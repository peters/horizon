...
/// until it collapses into a glyph-wide strip. Bounding the label by a width
/// derived from the content area — not the tooltip's own measured size —
/// breaks that feedback loop while keeping long text elided.
