...
const CLAUDE_PLUGIN_FILES: &[EmbeddedFile] = &[
    EmbeddedFile {
        ...
        content: include_str!("../../../assets/plugins/claude-code/.claude-plugin/plugin.json"),
    },
    EmbeddedFile {
        relative_path: "skills/horizon-notify/SKILL.md",
        content: include_str!("../../../assets/plugins/claude-code/skills/horizon-notify/SKILL.md"),
    },
];

const CODEX_PLUGIN_FILES: &[EmbeddedFile] = &[EmbeddedFile {
    relative_path: "SKILL.md",
    content: include_str!("../../../assets/plugins/codex/skills/horizon-notify/SKILL.md"),
}];
