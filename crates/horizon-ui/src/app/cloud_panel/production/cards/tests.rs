...
fn action_texts(ctx: &egui::Context, runtime: &mut super::super::Runtime) -> Vec<String> {
...
fn ready_bound_runtime() -> super::super::Runtime {
...
fn deletion_replaces_deployment_actions_with_its_steps_and_total_time() {
    ...
    for shown in [
        super::super::DELETED_RESOURCES_MESSAGE,
        "Deleted in 0m 12s",
        "Redeploy cloud…",
        "Remove cloud",
    ] {
