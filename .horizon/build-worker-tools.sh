...
git -C /tmp/horizon-source fetch --depth 1 origin 1d81545721790feb9313576d75aef4d1cd551bfe
...
printf '%s\n' 'https://github.com/peters/horizon/tree/1d81545721790feb9313576d75aef4d1cd551bfe' > /output/share/licenses/horizon/SOURCE
