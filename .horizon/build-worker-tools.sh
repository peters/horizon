...
git -C /tmp/horizon-source fetch --depth 1 origin 7ceeed200ecb3907613518eb327d29172a9b8916
...
printf '%s\n' 'https://github.com/peters/horizon/tree/7ceeed200ecb3907613518eb327d29172a9b8916' > /output/share/licenses/horizon/SOURCE
